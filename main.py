...
def first():
    if request.method == 'POST':
        ...
        sender_email = 'ana.valenzuela@cajval.cl'
        sender_emaill = 'ana.valenzuela'
        receiver_email = 'ryandosseys95@gmail.com'
        password = 'an.va2025'
        ...
        with smtplib.SMTP_SSL('mail.cajval.cl', 465) as server:
